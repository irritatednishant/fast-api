...
class Student(BaseModel):
    id:Annotated[str, Field(..., description='ID of the student')]
...
def vies_student(student_id:str =Path(...,description="ID of student in db", example='[1,2,3]')):
    data = load_data()
...
def sort_student(sort_by: str = Query(...,description='Sort student pn the basis of their name, enrolment and cgpa'),
    ...
    valid_fields = ['name','enrolment_no','cgpa']
